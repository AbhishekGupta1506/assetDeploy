 ...
 * 
 */
package com.webmethods.caf.deploytesttaskinboxbar;
...
public class DeployTestTaskInboxBarDefaultviewView extends com.webmethods.caf.faces.bean.task.BaseTaskInboxBarPageBean {
	...
	public ISavedSearchProvider getSavedSearchProvider() {
		if (fSavedSearchProvider == null) {
			fSavedSearchProvider = new DboSavedSearchProvider(getSearchQueryFactory(), "DeployTestTask Saved Searches" );
		}
	...
	private com.webmethods.caf.deploytesttaskinboxbar.DeployTestTaskInboxBar deployTestTaskInboxBar = null;
	...
	public com.webmethods.caf.deploytesttaskinboxbar.DeployTestTaskInboxBar getDeployTestTaskInboxBar()  {
		if (deployTestTaskInboxBar == null) {
		    deployTestTaskInboxBar = (com.webmethods.caf.deploytesttaskinboxbar.DeployTestTaskInboxBar)resolveExpression("#{DeployTestTaskInboxBar}");
		}
		return deployTestTaskInboxBar;
	}
